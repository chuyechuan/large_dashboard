  ...
  return (
    <div className="flex flex-1 justify-center absolute top-0 left-0 w-full h-full bg-white">
      ...
      <div className="flex-1 flex flex-col relative z-2">
        ...
        {/* <Side direction="l" /> */}
        <div className={`absolute top-0 left-0 w-96 h-full bg-gradient-to-l from-black/0 to-black`}></div>
        {/* <div className="flex-1"></div> */}
        {/* <Side direction="r" /> */}
        <div className={`absolute top-0 right-0 w-96 h-full bg-gradient-to-r from-black/0 to-black`}></div>
        {/* </div> */}
        {/* <Horizon direction="b" /> */}
        <div className={`absolute bottom-0 w-full h-28 bg-gradient-to-b from-black/0 to-black`}></div>
      </div>
    </div>
  );
};
